...
int main()
{
	...
	// initialize map data
	planner.InitMap(map_waypoints_x,
					map_waypoints_y,
					map_waypoints_s,
					map_waypoints_dx,
					map_waypoints_dy);
		...
		if (length && length > 2 && data[0] == '4' && data[1] == '2')
		{
			...
			if (s != "")
			{
				...
				if (event == "telemetry")
				{
					...
					planner.UpdateCarState(car_x, car_y, car_s, car_d, car_yaw, car_speed);
					planner.UpdatePreviousPathState(previous_path_x, previous_path_y, end_path_s, end_path_d);
